module SpreeSquare
  ...
  # model now lives at SpreePos::Modifier; this subclass exists only so
  ...
  #
  # No `type` column exists on spree_pos_modifiers, so this is plain AR
  # subclassing -- not STI.
  class Modifier < SpreePos::Modifier
  end
end
